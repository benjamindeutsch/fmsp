...
% Write here your notes, if any, for the xorshift prediction task.
% You can specify
% ---
...
% Present and discuss your Horn-clause encoding, research the difference between
% small-step and big-step semantics, and discuss the nature of the semantics
% of DO-WHILE.

\subsection*{Project Task 5.1: Proving Properties of xorshift}
% Write here your notes, if any, for the Lean proof task.
% You can specify
% ---
% as the section content if you don't have any note.
